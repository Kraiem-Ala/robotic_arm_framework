...
int main(int argc, char **argv)
{
	...
	MatrixXf theta(4,1), Xd(3, 1), fwd(5,1), Xf(3, 1),Xw(3, 1);
	ros::NodeHandle n;
	...
	INV(0, 0) = constrainAngle(INV(0, 0));
	...
	//INV2(4, 0) = constrainAngle(INV2(4, 0));
	...
	INV3(0, 0) = constrainAngle(INV3(0, 0));
